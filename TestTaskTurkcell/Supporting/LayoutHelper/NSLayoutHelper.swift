/*
 1. Configure constraint for different sizes with help of NSLayoutHelper custom class:
 (It caused because design pictures size with shadows)
 1.1 Find necessary constraint
 1.2 Make subclass of NSLayoutHelper
 1.3 Configure size for different devices
 */
